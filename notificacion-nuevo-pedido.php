...
<table style="background-color: white;width: 100%">
  <tr>
    <td style="border-bottom: 1px solid #eee;padding-top: 15px;padding-left: 15px;padding-right: 15px;padding-bottom: 15px">
      <h2 style="margin-top: 0px;margin-bottom: 0px;text-align:center;font-family:Roboto,sans-serif;margin-top: 0px;margin-bottom: 0px;">Nuevo pedido #'.$num_pedido.'</h2>
...
if($target_file_archivo !=""){
  $body .= '<h4 style="font-family:Roboto,sans-serif;margin-top: 0px;margin-bottom: 0px;">Archivo de diseño: <a href="http://localhost/fueralinea/'.$target_file_archivo.'" style="color:blue">Archivo</a></h4>';
} else {
  $body .= '<h4 style="font-family:Roboto,sans-serif;margin-top: 0px;margin-bottom: 0px;">Archivo de diseño: <a href="#" style="color:blue">Sin archivo de diseño</a></h4>';
}

      


        $body .= '<h4 style="font-family:Roboto,sans-serif;margin-top: 0px;margin-bottom: 0px;">Observaciones: '.$obs.'</h4>
...
$message = (new Swift_Message('Nuevo pedido fuera de línea #'.$num_pedido.' '))
