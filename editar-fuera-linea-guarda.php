...
if(isset($_POST["numeroPedido"]) && isset($_POST["cliente"]) && isset($_POST["proyecto"]) && isset($_POST["cantidad"])){
/*------------Actualizar pedidos--------*/


$num_pedido = $_POST["numeroPedido"];
$num_pedido= str_replace("'", "´", $num_pedido);
...
$sql2 = "UPDATE pedidos_fuera SET tipo_cliente='$tipoCliente', cliente='$cliente', autoriza='$personaAutorizacion', correo_autoriza='$correoAutoriza', area='$areaResponsable', proyecto='$proyecto', cantidad='$cantidad', sustrato='$sustrato', tipo_impresion='$tipo_impresion',  otro='$otro',  responsable_diseno='$disenoResposanble',  fecha_requerimiento='$fechaRequerimiento',    obs='$obs' WHERE id='$num_pedido'";
